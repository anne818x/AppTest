...
// Verberg het popupscherm.
function hidePopUpScreenRefresh()
{
    refreshPopupActive = false;
...
/*fixed, only popup shows, after clicking ok complete list shows*/
function refreshedAlert()
{
    refreshPopupActive = true;
	$("#internal-popup").hide();
    ...
    $("#popUpScreen").append("<div id='popUpText' class='text'>De pagina is vernieuwd!</div>");
	 $("#popUpScreen").append("<div id='popUpButton'><img onclick='hidePopUpScreenRefresh();' src='img/ok.png' alt='ok'/></div>");
}
;
...
function checkDropDown() {
	/*must close when person filters on branch*/
